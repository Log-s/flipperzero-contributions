...
static const uint16_t hid_asciimap[] = {
    ...
    HID_KEYBOARD_Q | KEY_MOD_LEFT_SHIFT, // A
    ...
    HID_KEYBOARD_Z | KEY_MOD_LEFT_SHIFT, // W
    HID_KEYBOARD_X | KEY_MOD_LEFT_SHIFT, // X
    HID_KEYBOARD_Y | KEY_MOD_LEFT_SHIFT, // Y
    HID_KEYBOARD_W | KEY_MOD_LEFT_SHIFT, // Z
